...
#include <Windows.h>
Car car(200, 100);
truck vehicle(200, 400, 2);
truck vehicle2(250, 600, 2.5);

misc tree1(365, 700, 1);
misc tree2(365, 900, 1);
misc tree3(365, 1100, 1);

misc coins(66, 750, 2);
misc gasoline(100, 2500, 2);
...
namespace game
{
	...
	{
		std::cout << "	||===============================================================||\n";
		std::cout << "	||                 '' HELLO WELLCOME IN GAME ''                  ||\n";
		std::cout << "	||===============================================================||\n";
		...
		slWindow(480, 600, "GAME ASIK", false);
